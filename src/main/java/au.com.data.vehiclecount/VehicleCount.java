package au.com.data.vehiclecount;
...
public class VehicleCount extends Configured implements Tool {

    private static final Logger logger = LoggerFactory.getLogger(VehicleCount.class);
    ...
    {
        int res = ToolRunner.run(new Configuration(), new VehicleCount(), args);
        System.exit(res);
    }
}
